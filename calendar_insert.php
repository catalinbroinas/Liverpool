...
function validation()
{
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") 
	{
		...
		if (empty($data))  
		{
			$messageInput = $validation->inputMessage($data, "ziua meciului", "danger");
...
function insert()
{
	...
	$query = "INSERT INTO calendar (month, year, data, city, stadium, iconC, iconT, team, status,  goalsH, goalsA, link )
				VALUES ($month, $year, '$data', '$city', '$stadium', '$iconC', '$iconT', '$team', '$status', $goalsH, $goalsA, '$link' )";
