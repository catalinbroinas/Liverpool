...
function insert()
{
	...
	$query = "INSERT INTO team (img1, img2, img3, nr, fname, lname, nickName, role, 
	birthday, valueMarket, imgFlag, flag, international, season )
				VALUES ('$img1', '$img2', '$img3', $nr, '$fname', '$lname', '$nickName', '$role', 
	'$birthday', $valueMarket, '$imgFlag', '$flag', '$international', '$season' )";
