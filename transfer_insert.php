...
function insert()
{
	...
	$query = "INSERT INTO Transfer (imgPlayer, img2Player, imgClub, img2Club, name, age, 
	role, valueTransfer, status, club, data, sezon )
				VALUES ('$imgPlayer', '$img2Player', '$imgClub', '$img2Club', '$name', $age, 
	'$role', $valueTransfer, '$status', '$club', '$data', '$sezon' )";
