...
function validation()
{
	$brand = $team = $games = $wins = $draws = $loss = $attack = $defensive = $goals = $points = 
	$season = "";
	$isError = false;
...
function update()
{
	...
	$query = "UPDATE clasament SET	brand = '$brand' , team = '$team', games = $games ,
			wins = $wins, draws = $draws, loss = $loss, 
			attack = $attack, defensive = '$defensive', goals = $goals ,
			points = '$points', season = '$season' WHERE id = $id ";
